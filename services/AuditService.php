...
class AuditService extends Component
{
    ...
    public const ACTION_ARTIFACT_QUOTA_TRIMMED = AuditLog::ACTION_ARTIFACT_QUOTA_TRIMMED;
    ...
    public const ACTION_RUNNER_UPDATED = AuditLog::ACTION_RUNNER_UPDATED;
    ...
    public const ACTION_WORKFLOW_TEMPLATE_TRIGGER_TOKEN_GENERATED = AuditLog::ACTION_WORKFLOW_TEMPLATE_TRIGGER_TOKEN_GENERATED;
    public const ACTION_WORKFLOW_TEMPLATE_TRIGGER_TOKEN_REVOKED = AuditLog::ACTION_WORKFLOW_TEMPLATE_TRIGGER_TOKEN_REVOKED;
